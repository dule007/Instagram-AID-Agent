...
def feed_svg_v2(item: dict) -> str:
    ...
    <rect x="110" y="950" width="520" height="82" rx="41" fill="{C['navy']}"/><text x="370" y="1002" text-anchor="middle" fill="{C['ink']}" font-size="22" font-weight="900">DOGOVORITE PRIKAZ — LINK U BIU →</text>'''
...
def story_svg_v2(item: tuple[str, str, str, list[str], list[str], str]) -> str:
    ...
    n = int(content_id[-2:])
    if n == 1:
        body = f'''<text x="90" y="430" fill="{C['ink']}" font-size="70" font-weight="900">Što vam danas</text><text x="90" y="515" fill="{C['amber']}" font-size="70" font-weight="900">češće stiže?</text><rect x="70" y="700" width="455" height="470" rx="34" fill="{C['navy2']}" stroke="{C['line']}"/><text x="298" y="860" text-anchor="middle" fill="{C['muted']}" font-size="27" font-weight="800">A</text><text x="298" y="970" text-anchor="middle" fill="{C['ink']}" font-size="42" font-weight="900">IZVJEŠTAJ</text><rect x="555" y="700" width="455" height="470" rx="34" fill="{C['amber']}"/><text x="782" y="860" text-anchor="middle" fill="{C['navy']}" font-size="27" font-weight="800">B</text><text x="782" y="955" text-anchor="middle" fill="{C['navy']}" font-size="42" font-weight="900">JASNA</text><text x="782" y="1015" text-anchor="middle" fill="{C['navy']}" font-size="42" font-weight="900">ODLUKA</text><text x="540" y="1450" text-anchor="middle" fill="{C['blue']}" font-size="25" font-weight="800">ODGOVORITE NAM PORUKOM ↓</text>'''
